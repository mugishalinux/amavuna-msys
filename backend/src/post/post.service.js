...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.createPost = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user, post, data_1, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_entity_1.User.findOne({
                            where: { id: data.user, status: (0, typeorm_1.Not)(8) }
                        })];
                    case 1:
                        user = _a.sent();
                        if (!user)
    ...
    PostService.prototype.getAllPost = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var post;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, post_entity_1.Post.find({
    ...
    PostService.prototype.getSinglePost = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var post;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        post = _a.sent();
                        if (!post)
                            throw new common_1.BadRequestException("Post with ID ".concat(id, " not found"));
                        return [2 /*return*/, post];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        post.status = 8;
                        return [4 /*yield*/, post_entity_1.Post.update(post.id, post)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, this.response.deleteResponse(post.id)];
                    case 4:
                        error_2 = _a.sent();
