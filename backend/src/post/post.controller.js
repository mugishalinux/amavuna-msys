...
var PostController = /** @class */ (function () {
    function PostController(postService, authService, filter, jwtService) {
        this.postService = postService;
        this.authService = authService;
        this.filter = filter;
        this.jwtService = jwtService;
    }
    PostController.prototype.createPost = function (data, req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.postService.createPost(data)];
            });
        });
    };
    PostController.prototype.getSinglePost = function (id, req) {
        console.log();
        return this.postService.getSinglePost(id);
    };
    PostController.prototype.getAllPost = function (req) {
    ...
    __decorate([
        ...
        __param(1, (0, common_1.Request)())
    ], PostController.prototype, "getSinglePost");
    __decorate([
        (0, swagger_1.ApiBearerAuth)(),
        (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
        (0, common_1.Get)(""),
