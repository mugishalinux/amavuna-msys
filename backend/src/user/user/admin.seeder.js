...
var AdminSeeder = /** @class */ (function () {
    function AdminSeeder(response) {
        this.response = response;
    }
    AdminSeeder.prototype.onApplicationBootstrap = function (app) {
        return __awaiter(this, void 0, void 0, function () {
            var admin, user, salt, hashedPassword, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_entity_1.User.findOne({
                            where: { primaryPhone: process.env.PHONE, status: (0, typeorm_1.Not)(8) }
                        })];
                    case 1:
                        admin = _a.sent();
                    ...
                    case 2:
                        salt = _a.sent();
                        return [4 /*yield*/, bcrypt.hash(process.env.KEY, 12)];
                    case 3:
                    ...
                    case 6:
                        error_1 = _a.sent();
                        console.log("something wrong : ", error_1);
                        return [3 /*break*/, 7];
