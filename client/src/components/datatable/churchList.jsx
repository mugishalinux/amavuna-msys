...
import { userColumns, churchColumns, userRows } from "../../datatablesource";
...
const ChurchList = () => {
  ...
  const handleChurchInputChange = (event) => {
    setCategoryName(event.target.value);
  };
  ...
  const handleCategoryModalSubmit = () => {
    ...
    axios
      .post(
        `${BASE_URL}/church/creation`,
        { churchName: categoryName.trim() },
        {
          headers: {
            Authorization: `Bearer ${auth().jwtToken}`,
          },
  ...
  const handleUpdateCategoryModalSubmit = (event) => {
    ...
    axios
      .put(
        `${BASE_URL}/church/${tempId}`,
        { churchName: categoryName },
        {
          headers: {
            Authorization: `Bearer ${auth().jwtToken}`,
          },
        ...
        return (
          <div className="cellAction">
            ...
            <div
              className="deleteButton"
              onClick={() => {
                let url = `${BASE_URL}/church/${params.row.id}`;
                fetch(url, {
                  method: "DELETE",
                  headers: {
                  ...
                  .then((response) => {
                    response.json();
                    toast.success("Church was successfully deleted", {
                      position: "top-right",
                      autoClose: 2000,
                      hideProgressBar: false,
                      closeOnClick: true,
    ...
    <>
      <div className="datatable">
        ...
        <DataGrid
          ...
          columns={churchColumns.concat(actionColumns)}
          pageSize={9}
      ...
      <div>
        <Dialog
          ...
          maxWidth="md"
        >
          <DialogTitle>Update Church </DialogTitle>
          <DialogContent>
            <form onSubmit={handleUpdateCategoryModalSubmit}>
              <TextField
                ...
                variant="outlined"
                value={categoryName}
                onChange={handleChurchInputChange}
                fullWidth
              />
              <Button
                type="submit"
      ...
      <Dialog
        ...
        maxWidth="md"
      >
        <DialogTitle>Update Category ffdfd</DialogTitle>
        <DialogContent>
          <form onSubmit={handleCategoryModalSubmit}>
            <TextField
              id="categoryName"
